...
1. **Web-сервис и API: основы обмена данными (ЛР-1)**
...
2. **Проектирование клиентской части: HTML как архитектурный слой (ЛР-2)**
...
3. **Стилизация интерфейса: CSS как слой представления (ЛР-3)**
...
4. **Клиентская бизнес-логика: JavaScript в браузере (ЛР-4)**
...
5. **Инженерная дисциплина разработки (сквозная тема всех ЛР)**
